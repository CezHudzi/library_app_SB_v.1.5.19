...
public class BorrowMapper {
    ...
    {
        return new BorrowResponse(borrow.getBorrowedAt(), borrow.getReturnAt(), borrow.getFine(),borrow.getFineEuro(), borrow.getPersonName(), borrow.getPersonSurename(), borrow.getBookName() );
    }
